...
public class CreateDataintoXlsx {

	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		FileOutputStream file=new FileOutputStream(System.getProperty("user.dir")+"\\TestData\\Bookdata.xlsx");
		...
		row2.createCell(1).setCellValue(9);
