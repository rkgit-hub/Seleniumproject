...
public class ExcelUtils {
	...
	public static String getCellData(String xlfile,String xlsheet,int rownum,int cellnum) throws IOException
	{
		...
		try
		{
			//data=cell.toString(); // get the data in String format & read the data in String format 
			DataFormatter formatter=new DataFormatter(); // Appache poi provided special class
